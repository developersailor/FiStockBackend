...
namespace FiStockBackend.Migrations
{
    ...
    [Migration("20241118230610_kasim-19-02-06")]
    partial class kasim190206
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FiStockBackend.Models.StockMovement", b =>
                {
                    ...
                    b.HasOne("FiStockBackend.Models.Warehouse", "SourceDestination")
                        .WithMany("StockMovements")
                    ...
                    b.Navigation("SourceDestination");
                });
